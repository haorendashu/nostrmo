...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "Add_a_Note":
            MessageLookupByLibrary.simpleMessage("Δημοσίευση ενημερώσεων"),
        ...
        "Background_Image":
            MessageLookupByLibrary.simpleMessage("Εικόνες φόντου"),
        ...
        "Copy_Note_Id":
            MessageLookupByLibrary.simpleMessage("Αντιγραφή δυναμικού ID"),
        "Copy_Note_Json":
            MessageLookupByLibrary.simpleMessage("Αντιγραφή δυναμικού Json"),
        ...
        "Create_Group":
            MessageLookupByLibrary.simpleMessage("Δημιουργία ομάδας"),
        ...
        "Data_Length":
            MessageLookupByLibrary.simpleMessage("Αριθμός δεδομένων"),
        ...
        "Default_Font_Family":
            MessageLookupByLibrary.simpleMessage("προεπιλεγμένη γραμματοσειρά"),
        "Default_index":
        ...
        "Edit_name":
            MessageLookupByLibrary.simpleMessage("Επεξεργασία ονόματος"),
        ...
        "Follow_set":
            MessageLookupByLibrary.simpleMessage("Ακολουθήστε το σετ"),
        ...
        "Followed_Communities":
            MessageLookupByLibrary.simpleMessage("Ακολούθησε η Κοινότητα"),
        "Followed_Tags":
        ...
        "Forbid_profile_picture":
            MessageLookupByLibrary.simpleMessage("Απαγόρευση εικόνων avatar"),
        "Forbid_video":
            MessageLookupByLibrary.simpleMessage("Απαγόρευση βίντεο"),
        "From": MessageLookupByLibrary.simpleMessage("από"),
        "Full_Mode":
            MessageLookupByLibrary.simpleMessage("Λειτουργία πλήρους αριθμού"),
        ...
        "Hint_Font_Color":
            MessageLookupByLibrary.simpleMessage("Χρώμα κειμένου συμβουλών"),
        ...
        "Image_service_path":
            MessageLookupByLibrary.simpleMessage("Διεύθυνση υπηρεσίας εικόνας"),
        "Import_notes":
        ...
        "Lightning_Address":
            MessageLookupByLibrary.simpleMessage("Διεύθυνση αστραπής"),
        "Lightning_Invoice":
        ...
        "Login_With_NIP07_Extension":
            MessageLookupByLibrary.simpleMessage("Σύνδεση με το plugin NIP07"),
        "Login_fail": MessageLookupByLibrary.simpleMessage("Αποτυχία σύνδεσης"),
        "Lud16": MessageLookupByLibrary.simpleMessage("Lud16"),
        "Main_Font_Color":
            MessageLookupByLibrary.simpleMessage("Χρώμα κύριου κειμένου"),
        ...
        "Message_notice":
            MessageLookupByLibrary.simpleMessage("Ειδοποίηση μηνύματος"),
        ...
        "NWC_TIP2":
            MessageLookupByLibrary.simpleMessage("Ο σύνδεσμος NWC είναι έτσι."),
        "Name": MessageLookupByLibrary.simpleMessage("όνομα"),
        "Network": MessageLookupByLibrary.simpleMessage("δίκτυο"),
        "New_message_receive":
            MessageLookupByLibrary.simpleMessage("Λάβετε νέα μηνύματα"),
        "New_note_receive":
            MessageLookupByLibrary.simpleMessage("Λάβετε νέα δυναμική"),
        ...
        "Note_Client_Tag":
            MessageLookupByLibrary.simpleMessage("Δυναμική ετικέτα πελάτη"),
        ...
        "Note_Id":
            MessageLookupByLibrary.simpleMessage("Δυναμικό αναγνωριστικό"),
        ...
        "Note_loading":
            MessageLookupByLibrary.simpleMessage("Δυναμική φόρτωση"),
        ...
        "Please_select_relays":
            MessageLookupByLibrary.simpleMessage("Επιλέξτε το μετάδοση"),
        "Poll": MessageLookupByLibrary.simpleMessage("ψηφοφορία"),
        "Popular_Users":
            MessageLookupByLibrary.simpleMessage("Δημοφιλείς χρήστες"),
        ...
        "Search_User_from_cache":
            MessageLookupByLibrary.simpleMessage("Εύρεση χρηστών από τη μνήμη"),
        ...
        "Send_interval":
            MessageLookupByLibrary.simpleMessage("Διαστάσεις αποστολής"),
        "Sensitive_Content":
        ...
        "Show_Window":
            MessageLookupByLibrary.simpleMessage("Εμφάνιση παραθύρου"),
        ...
        "Split_and_Transfer_Zap":
            MessageLookupByLibrary.simpleMessage("Διαίρεση και μεταφορά Zap"),
        "Subject": MessageLookupByLibrary.simpleMessage("τίτλος"),
        "Submit": MessageLookupByLibrary.simpleMessage("Υποβολή"),
        "Sync_Upload":
            MessageLookupByLibrary.simpleMessage("Συγχρονισμός αποστολής"),
        "Table_Mode":
        ...
        "Thread_Mode":
            MessageLookupByLibrary.simpleMessage("Λεπτομέρειες Mode"),
        ...
        "Trace_Mode":
            MessageLookupByLibrary.simpleMessage("Λειτουργία παρακολούθησης"),
        "Translate": MessageLookupByLibrary.simpleMessage("μετάφραση"),
        "Translate_Source_Language":
            MessageLookupByLibrary.simpleMessage("Γλώσσα πηγής μετάφρασης"),
        ...
        "What_s_happening":
            MessageLookupByLibrary.simpleMessage("Υπάρχει κάτι ενδιαφέρον;"),
        ...
        "Zap_number_not_enough":
            MessageLookupByLibrary.simpleMessage("Ανεπαρκής αριθμός flash"),
        ...
        "min_zap_num":
            MessageLookupByLibrary.simpleMessage("Ελάχιστος αριθμός Zaps"),
